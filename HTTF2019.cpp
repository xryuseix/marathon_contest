...
int main(void) {
    ...
    for(int i=1;i<n-1;i++){
        for(int j=1;j<n-1;j++){
            if(info[i][j]!=info[i+1][j]||info[i][j]!=info[i-1][j]||info[i][j]==2||info[i][j]==4||info[i][j-1]==2||info[i][j+1]==4||grid[i][j]==1)continue;
    ...
    for(int i=1;i<n-1;i++){
        for(int j=1;j<n-1;j++){
            if(info[i][j]!=info[i][j+1]||info[i][j]!=info[i][j-1]||info[i][j]==1||info[i][j]==3||info[i-1][j]==3||info[i+1][j]==1||grid[i][j]==1)continue;
    ...
    for(int i=1;i<n-1;i++){
        for(int j=0;j<n;j++){
            if(grid[i-1][j]==2&&grid[i+1][j]==2&&grid[i][j]!=1){
                info[i][j]=0;
            }
        }
    }
    for(int i=0;i<n;i++){
        for(int j=1;j<n-1;j++){
            if(grid[i][j-1]==2&&grid[i][j+1]==2&&grid[i][j]!=1){
                info[i][j]=0;
            }
        }
    }
